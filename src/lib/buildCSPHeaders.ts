// Local imports
import {
  type CSPDirectiveConfigValue,
  type CSPDirectivesConfig,
...
export const buildCSPHeaders = (options: Options = {}) => {
  ...
  const reportOnly =
    typeof contentSecurityPolicy.reportOnly === 'boolean' &&
